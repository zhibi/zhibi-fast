package zhibi.fast.ueditor.hunter;

import zhibi.fast.ueditor.PathFormat;
import zhibi.fast.ueditor.define.*;
...
public class ImageHunter {
    ...
    public State captureRemoteData(String urlStr) {
        ...
        try {
            ...
            State state = storage.saveFileByInputStream(connection.getInputStream(), this.rootPath, savePath, urlPrefix);
