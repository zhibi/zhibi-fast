...
public class StorageManager implements IStorageManager {
    ...
    @Override
    public State saveBinaryFile(byte[] data, String rootPath, String savePath, String urlPrefix) {
        ...
        state.putInfo("url", PathFormat.format(urlPrefix + savePath));
    ...
    @Override
    public State saveFileByInputStream(InputStream is, String rootPath, String savePath, String urlPrefix) {
        State state = null;
